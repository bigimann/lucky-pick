...
export default function Twitter() {
  ...
  const handleFetch = (e) => {
    e.preventDefault();
    if (link.trim() === "") {
      alert("Please enter an Twitter post link");
    } else {
  ...
  const faqs = [
    {
      ...
      a: "This tool extracts comments from a public Twitter post and allows you to randomly select winners for your giveaways.",
    },
    {
      q: "Do I need to log in with my Twitter account?",
      a: "No. LuckyPick does not require or store any login credentials. Simply paste the public Twitter post link to proceed.",
    },
    {
    ...
    {
      q: "Can I use this tool for private Twitter posts?",
      a: "No. Only public Twitter posts can be used, since Twitter limits access to private content for security and privacy reasons.",
    },
    {
      q: "Is this tool affiliated with Twitter?",
      a: "No. LuckyPick is an independent platform and is not connected to Twitter, Meta, or any of its subsidiaries.",
    },
  ];
    ...
    <div className="min-h-screen bg-[#eef2f3] flex flex-col items-center justify-center p-6">
      ...
      <section className="text-center mb-10 mt-16">
        ...
        <p className="text-gray-500 mt-1">
          Extract and Select Random Giveaway Winners from Twitter
        </p>
      </section>
      ...
      >
        <input
          type="text"
          value={link}
          placeholder="Enter Twitter link only..."
      ...
      >
        ...
        <p className="">
          ...
          <span className="font-bold">
            ...
            any way with Twitter or the Meta Platforms, Inc. brand.
          </span>
        </p>
      </section>
